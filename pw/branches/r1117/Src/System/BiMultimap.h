...
TContainer1 и TContainer2 должны быть последовательностями ( STL Sequence )

метод Add( k1, k2[] )
добавляет соответствия k1 <-> каждый элемент k2

метод Del( k )
удаляет все соответствия с участием k

метод Get( k )
возвращает ассоциированные с k элементы другого множества

метод Has( k )
сообщает, существует ли хотя бы одно соответствие для данного объекта k
*/
