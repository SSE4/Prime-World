...
Тут можно будет прочитать всякие свойства объекта на карте.\n\
Увеличьте карту вращая колесо мыши, и выбирите интересуемый фрагмент,\n\
нажав левую кнопку и потащив мышь. Ткните на объекте правой кнопкой мыши.\n\
\n\
Кнопки:\n\
H: карта высот\n\
V: туман войны\n\
